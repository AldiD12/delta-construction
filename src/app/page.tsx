...
<section className="trust">
  <div className="trust-inner">
    ...
    <div className="trust-logos">
      <span className="tl"><img src="/uploads/gas-safe.png" alt="Gas Safe Registered" style={{height:"28px",width:"auto"}} /></span>
      <span className="tl"><img src="/uploads/niceic.png" alt="NICEIC Approved Contractor" style={{height:"28px",width:"auto"}} /></span>
    </div>
  </div>
</section>
